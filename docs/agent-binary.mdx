...
The Agent needs to run as a privileged user to load necessary eBPF programs to Kernel. Please check [our FAQ for further information](http://localhost:3000/docs/faq#since-parca-agent-has-to-run-as-root-for-ebpf-what-are-the-security-considerations).
