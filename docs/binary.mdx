...
<WithVersions language="bash">
  { versions =>
    <CodeBlock className="language-bash">
      curl -sL https://github.com/parca-dev/parca/releases/download/{versions.server}/parca_{versions.server}_`uname -s`_`uname -m`.tar.gz | tar xvfz ./parca
    </CodeBlock>
  }
</WithVersions>
...
<WithVersions language="bash">
  { versions =>
    <CodeBlock className="language-bash">
      docker pull github.com/parca-dev/parca:{versions.server}
    </CodeBlock>
  }
</WithVersions>
