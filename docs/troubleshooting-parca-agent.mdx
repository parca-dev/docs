...
To reach out to eBPF program logs use `bpftool prog tracelog`. You could also find the following document useful for further troubleshooting techiques using `bpftool`: [https://qmonnet.github.io/whirl-offload/2021/09/23/bpftool-features-thread](https://qmonnet.github.io/whirl-offload/2021/09/23/bpftool-features-thread/)
